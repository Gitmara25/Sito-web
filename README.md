...
Una volta fatto l'accesso a page cms (https://pagescms.org/), ed apportato le modifiche necessarie, per poterle pubblicare bisogna andare su Netlify (https://www.netlify.com/) accedendo con l'account Github (che farà in automatico se l'accesso è già stato fatto una volta).  
1. Cliccare sul sito.
...
4. Cercare 'Build Settings' e cliccare 'Configure'.
5. Nella sezione 'Build Status' cliccare su 'stopped builds' e cliccare 'Save'.
